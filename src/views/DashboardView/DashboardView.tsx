...
const DashboardView: FC = () => {
  ...
  return (
    <div className='p-0 m-0 w-full h-full min-h-fit'>
      <div className='flex overflow-x-hidden overflow-y-scroll flex-col m-0 w-screen h-screen md:flex-row-reverse'>
        <div
          id='search-box'
          className='flex flex-auto justify-center items-start p-0 bg-white md:w-1/3 lg:w-1/4'
        >
          <div className='container flex-col items-start p-0'>
